...
#Set URLs
$url_Desktop = "https://raw.githubusercontent.com/John-NetworkElites/Intune-Public/main/AlyJoke.png"
...
$directory = "c:\NetworkElites"
$DesktopImageValue = "$directory\wallpaperJoke.png"
